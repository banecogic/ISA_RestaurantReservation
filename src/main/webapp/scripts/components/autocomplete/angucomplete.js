...
angular.module('rrappApp')
    .directive('angucomplete', function (FriendRequestSharedPropertyService, $parse, $http, $sce, $timeout, $log, $rootScope) {
        return {
            restrict: 'EA',
            scope: {
                "id": "@id",
            ...
            link: function($scope, elem, attrs) {
                ...
                $scope.searchTimerComplete = function(str) {
                    ...
                    if (str.length >= $scope.minLength) {
                        if ($scope.localData) {
                            $log.info('USAO U LOCALDATA BINDING!');
                            ...
                            $http.get($scope.url + $scope.searchStr, {}).
                ...
                $scope.keyPressed = function(event) {
                    $rootScope.$broadcast('selectedFriendToAdd', false);
                ...
                $scope.selectResult = function(result) {
                    ...
                    FriendRequestSharedPropertyService.setProperty(result);
                    $rootScope.$broadcast('selectedFriendToAdd', result);
                    $scope.showDropdown = false;
                    $scope.results = [];
                    //$scope.$apply();
                }
