            ...
            login: function (credentials, callback) {
                ...
                AuthServerProvider.login(credentials).then(function (data) {
                    ...
                    Principal.identity(true).then(function(account) {
                        $rootScope.account.activated = account.activated;
                        $rootScope.account.email = account.email;
                        $rootScope.account.firstName = account.firstName;
                        $rootScope.account.lastName = account.lastName;
                        $rootScope.account.login = account.login;
